...
不妨设系数矩阵 $\pmb{A}=(a_{ij})_{m×n}$ 为行满秩矩阵，即 $rank(\pmb{A})=m$

- 若 $rank(\pmb{A})<m$ ,则存在冗余约束
...
![](../../../assets/Pasted%20image%2020241006140308.png)
...
![](../../../assets/Pasted%20image%2020241006132831.png)
***
### 分枝定界法
...
!!! Example
	...
	IP: $\min -30x_1-36x_2,s.t.\begin{cases}x_1+x_2\leq 6\\5x_1+9x_2\leq 45\\x_1,x_2\geq 0,x_1,x_2\in\Z\end{cases}$
...
![](../../../assets/Pasted%20image%2020241007141638.png)
***
### 0-1 变量

![](../../../assets/Pasted%20image%2020241007142013.png)
***
## 多目标规划
...
![](../../../assets/Pasted%20image%2020241007142329.png)
***
### 主要目标法

![](../../../assets/Pasted%20image%2020241007142419.png)
***
### 理想点法

![](../../../assets/Pasted%20image%2020241007142518.png)

- 在实际情况下，我们可以将 $\lambda$ 取为 $1$，$\alpha$ 取为 $2$
***
### 分层排序法

![](../../../assets/Pasted%20image%2020241007142702.png)
***
### 例子：投资组合

![](../../../assets/Pasted%20image%2020241007142752.png)

采用主要目标法：

![](../../../assets/Pasted%20image%2020241007142839.png)

![](../../../assets/Pasted%20image%2020241007142928.png)

![](../../../assets/Pasted%20image%2020241007143024.png)
...
| ---------------------------------------------- | ------------------------------------------------- | --------------------------------------------------- | ----------------------------------------------- | ----- |
| $j=1$                                          | $\min\{\frac{5}{2}⋅1,\frac{15}{8}\}=\frac{15}{8}$ | $\min\{\frac{5}{3}⋅1,\frac{25}{12}\}=\frac{5}{3}$   | $\min\{\frac{5}{4}⋅1,\frac{5}{2}\}=\frac{5}{4}$ | $4$   |
| $j=2$                                          |                                                   | $\min\{\frac{5}{3}⋅2,\frac{25}{12}\}=\frac{25}{12}$ | $\min\{\frac{5}{4}⋅2,\frac{5}{2}\}=\frac{5}{2}$ | $1$   |

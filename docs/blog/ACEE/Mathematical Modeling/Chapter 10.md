...
!!! note "讨价还价公理"
	...
	!!! note "证明最优解存在唯一性"
		...
		- 唯一性：
			...
			- 不妨设 $x_1<x_2$，则 $y_1>y_2$。由 $S$ 的凸性 $(\frac{x_1+x_2}{2},\frac{y_1+y_2}{2})\in S$，而 $(\frac{x_1+x_2}{2}-x_0)(\frac{y_1+y_2}{2}-y_0)=(x_1-x_0)(y_1-y_0)+\frac{1}{4}(y_2-y_1)(x_1-x_2)>(x_1-x_0)(y_1_y_0)$ 矛盾

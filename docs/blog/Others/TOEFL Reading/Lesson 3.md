...
!!! example "Example 02"
	...
	The range of natural colors was hugely expanded and, indeed, superseded by the chemical dyes developed during the 1800s. By 1900 a full spectrum of synthetic colors had been evolved, many of them reaching a standard of resistance to fading from exposure to light and to washing that tremendously exceeded that of natural dyestuffs. Since then,the petroleum industry has added many new chemicals, and from these other types of dyestuffs have been developed. Much of the research in dyes was stimulated by the peculiarities of some of the new synthetic fibers--Acetate rayon, for example, seemed at first to have no affinity for dyes and a new range of dyes had to be developed; nylon and Tervlene presented similar problems.
	
	=== "Question"
	
		- According to the passage, how did chemical dyes compare to natural dyes?
			- A）They had less attractive colors.
			- B）They were less easy to use.
			- C）They lost their brightness more quickly when exposed to light.
			- D）They held up better.
	
	=== "Answer"
	
		- D）They held up better.
		
		根据原文 "reaching a standard of resistance to fading from exposure to light and to washing that tremendously exceeded that of natural dyestuffs" 可以得知与 D 相同。
...
| transcend                      | v.                 | 超过          | syn. surpass                                                                                   |
| a wide/full spectrum of        | /                  | 大量，各种各样的    | syn. an assortment of, a myriad/plethora of                                                    |
| evolve                         | v.                 | 进化          | vol- 表示卷<br>                                                                                   |
| volume                         | n.                 | （书）卷        |                                                                                                |
| involve                        | v.                 | 包含          | n. involvement                                                                                 |
| revolve                        | v.                 | 围绕          | revolve around<br>the revolving door                                                           |
| involuted                      | adj.               | 内卷的         | n. involution                                                                                  |
| convoluted                     | adj.               | 错综复杂的       |                                                                                                |
| devolution                     | n.                 | 权利下放        |                                                                                                |
| voluble                        | adj.               | 滔滔不绝的       | be voluble on 在...口若悬河                                                                         |
| supersede                      | v.                 | 取代          | sed-/sid- 表示坐<br>syn. replace, supplant                                                        |
| assiduous                      | adj.               | 勤勉的         | n. assiduity                                                                                   |
| sedative                       | n.                 | 镇静剂         | adj. sedate 文静的                                                                                |
| dissident                      | n.                 | 持不同意见的人     |                                                                                                |
| insidious                      | adj.               | 阴险的         |                                                                                                |
| preside                        | v.                 | 主持          | preside over 主持（会议）<br>n. president                                                            |
| reside                         | v.                 | 居住          | n. resident 居民, residence 居所<br>adj. residential                                               |
| residue                        | n.                 | 残留物         | adj. residual                                                                                  |
| subside                        | v.                 | 塌陷          | sub- 表示下                                                                                       |
